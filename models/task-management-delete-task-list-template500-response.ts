 ...
 * 
 * @export
 * @interface TaskManagementDeleteTaskListTemplate500Response
 */
export interface TaskManagementDeleteTaskListTemplate500Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof TaskManagementDeleteTaskListTemplate500Response
     */
    'title': string;
    /**
