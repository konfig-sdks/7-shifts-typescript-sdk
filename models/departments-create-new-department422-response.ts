 ...
 * 
 * @export
 * @interface DepartmentsCreateNewDepartment422Response
 */
export interface DepartmentsCreateNewDepartment422Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof DepartmentsCreateNewDepartment422Response
     */
    'title': string;
    /**
