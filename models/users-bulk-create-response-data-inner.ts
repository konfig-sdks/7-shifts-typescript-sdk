 ...
 * 
 * @export
 * @interface UsersBulkCreateResponseDataInner
 */
export interface UsersBulkCreateResponseDataInner {
    /**
     * User ID
     * @type {number}
     * @memberof UsersBulkCreateResponseDataInner
     */
    'id': number;
    /**
     * Internal use
     ...
     * @memberof UsersBulkCreateResponseDataInner
     */
    'invite_status': UsersBulkCreateResponseDataInnerInviteStatusEnum;
    /**
     ...
     * @memberof UsersBulkCreateResponseDataInner
     */
    'type': UsersBulkCreateResponseDataInnerTypeEnum;
    /**
     * Employee ID
     * @type {string}
     * @memberof UsersBulkCreateResponseDataInner
...
type UsersBulkCreateResponseDataInnerInviteStatusEnum = 'accepted' | 'pending' | 'required' | 'missing_contact_info'
type UsersBulkCreateResponseDataInnerTypeEnum = 'employee' | 'asst_manager' | 'manager' | 'employer'
