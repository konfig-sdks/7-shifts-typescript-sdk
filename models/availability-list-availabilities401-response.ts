 ...
 * 
 * @export
 * @interface AvailabilityListAvailabilities401Response
 */
export interface AvailabilityListAvailabilities401Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof AvailabilityListAvailabilities401Response
     */
    'title': string;
    /**
