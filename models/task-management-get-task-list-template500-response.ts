 ...
 * 
 * @export
 * @interface TaskManagementGetTaskListTemplate500Response
 */
export interface TaskManagementGetTaskListTemplate500Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof TaskManagementGetTaskListTemplate500Response
     */
    'title': string;
    /**
