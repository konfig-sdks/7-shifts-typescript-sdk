 ...
 * 
 * @export
 * @interface UserAssignmentsDeleteRoleAssignment404Response
 */
export interface UserAssignmentsDeleteRoleAssignment404Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof UserAssignmentsDeleteRoleAssignment404Response
     */
    'title': string;
    /**
