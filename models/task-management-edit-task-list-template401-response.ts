 ...
 * 
 * @export
 * @interface TaskManagementEditTaskListTemplate401Response
 */
export interface TaskManagementEditTaskListTemplate401Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof TaskManagementEditTaskListTemplate401Response
     */
    'title': string;
    /**
