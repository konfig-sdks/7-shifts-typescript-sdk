 ...
 * 
 * @export
 * @interface ExternalUserMappingsCreateMapping401Response
 */
export interface ExternalUserMappingsCreateMapping401Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof ExternalUserMappingsCreateMapping401Response
     */
    'title': string;
    /**
