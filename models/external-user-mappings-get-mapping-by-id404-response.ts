 ...
 * 
 * @export
 * @interface ExternalUserMappingsGetMappingById404Response
 */
export interface ExternalUserMappingsGetMappingById404Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof ExternalUserMappingsGetMappingById404Response
     */
    'title': string;
    /**
