 ...
 * 
 * @export
 * @interface TaskManagementDeleteTaskTags500Response
 */
export interface TaskManagementDeleteTaskTags500Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof TaskManagementDeleteTaskTags500Response
     */
    'title': string;
    /**
