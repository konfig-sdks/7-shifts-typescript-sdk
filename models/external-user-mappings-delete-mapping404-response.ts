 ...
 * 
 * @export
 * @interface ExternalUserMappingsDeleteMapping404Response
 */
export interface ExternalUserMappingsDeleteMapping404Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof ExternalUserMappingsDeleteMapping404Response
     */
    'title': string;
    /**
