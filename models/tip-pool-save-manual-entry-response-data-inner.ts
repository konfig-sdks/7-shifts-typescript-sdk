 ...
 * 
 * @export
 * @interface TipPoolSaveManualEntryResponseDataInner
 */
export interface TipPoolSaveManualEntryResponseDataInner {
    /**
     * Manual Entry UUID
     * @type {string}
     * @memberof TipPoolSaveManualEntryResponseDataInner
     */
    'uuid'?: string | null;
    /**
