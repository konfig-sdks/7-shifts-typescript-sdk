 ...
 * 
 * @export
 * @interface AvailabilityUpdateReasonById500Response
 */
export interface AvailabilityUpdateReasonById500Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof AvailabilityUpdateReasonById500Response
     */
    'title': string;
    /**
