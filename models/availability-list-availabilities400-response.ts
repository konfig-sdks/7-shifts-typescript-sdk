 ...
 * 
 * @export
 * @interface AvailabilityListAvailabilities400Response
 */
export interface AvailabilityListAvailabilities400Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof AvailabilityListAvailabilities400Response
     */
    'title': string;
    /**
