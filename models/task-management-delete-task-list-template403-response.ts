 ...
 * 
 * @export
 * @interface TaskManagementDeleteTaskListTemplate403Response
 */
export interface TaskManagementDeleteTaskListTemplate403Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof TaskManagementDeleteTaskListTemplate403Response
     */
    'title': string;
    /**
