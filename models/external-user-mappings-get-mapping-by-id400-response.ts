 ...
 * 
 * @export
 * @interface ExternalUserMappingsGetMappingById400Response
 */
export interface ExternalUserMappingsGetMappingById400Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof ExternalUserMappingsGetMappingById400Response
     */
    'title': string;
    /**
