 ...
 * 
 * @export
 * @interface ExternalUserMappingsCreateMapping409Response
 */
export interface ExternalUserMappingsCreateMapping409Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof ExternalUserMappingsCreateMapping409Response
     */
    'title': string;
    /**
