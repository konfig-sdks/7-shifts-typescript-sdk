 ...
 * 
 * @export
 * @interface DepartmentsUpdateDepartment403Response
 */
export interface DepartmentsUpdateDepartment403Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof DepartmentsUpdateDepartment403Response
     */
    'title': string;
    /**
