 ...
 * 
 * @export
 * @interface TaskManagementCreateTaskListTemplate409Response
 */
export interface TaskManagementCreateTaskListTemplate409Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof TaskManagementCreateTaskListTemplate409Response
     */
    'title': string;
    /**
