 ...
 * 
 * @export
 * @interface TaskManagementCreateTaskListTemplate422Response
 */
export interface TaskManagementCreateTaskListTemplate422Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof TaskManagementCreateTaskListTemplate422Response
     */
    'title': string;
    /**
