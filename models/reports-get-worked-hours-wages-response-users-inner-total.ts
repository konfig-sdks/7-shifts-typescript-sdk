 ...
 * @export
 * @interface ReportsGetWorkedHoursWagesResponseUsersInnerTotal
 */
export interface ReportsGetWorkedHoursWagesResponseUsersInnerTotal {
    /**
     * Regular hours
     * @type {number}
     * @memberof ReportsGetWorkedHoursWagesResponseUsersInnerTotal
     */
