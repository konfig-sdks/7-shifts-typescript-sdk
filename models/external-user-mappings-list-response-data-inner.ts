 ...
 * 
 * @export
 * @interface ExternalUserMappingsListResponseDataInner
 */
export interface ExternalUserMappingsListResponseDataInner {
    /**
     * Mapping ID
     * @type {number}
     * @memberof ExternalUserMappingsListResponseDataInner
     */
    'id': number;
    /**
     * User ID in 7Shifts
