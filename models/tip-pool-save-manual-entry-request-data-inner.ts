 ...
 * 
 * @export
 * @interface TipPoolSaveManualEntryRequestDataInner
 */
export interface TipPoolSaveManualEntryRequestDataInner {
    /**
     * Manual Entry UUID
     * @type {string}
     * @memberof TipPoolSaveManualEntryRequestDataInner
     */
    'uuid'?: string | null;
    /**
