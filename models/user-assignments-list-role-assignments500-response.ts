 ...
 * 
 * @export
 * @interface UserAssignmentsListRoleAssignments500Response
 */
export interface UserAssignmentsListRoleAssignments500Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof UserAssignmentsListRoleAssignments500Response
     */
    'title': string;
    /**
