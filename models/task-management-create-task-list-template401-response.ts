 ...
 * 
 * @export
 * @interface TaskManagementCreateTaskListTemplate401Response
 */
export interface TaskManagementCreateTaskListTemplate401Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof TaskManagementCreateTaskListTemplate401Response
     */
    'title': string;
    /**
