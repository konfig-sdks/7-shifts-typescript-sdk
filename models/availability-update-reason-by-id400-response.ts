 ...
 * 
 * @export
 * @interface AvailabilityUpdateReasonById400Response
 */
export interface AvailabilityUpdateReasonById400Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof AvailabilityUpdateReasonById400Response
     */
    'title': string;
    /**
