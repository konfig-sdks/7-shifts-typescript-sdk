 ...
 * 
 * @export
 * @interface UserAssignmentsCreateRoleAssignment400Response
 */
export interface UserAssignmentsCreateRoleAssignment400Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof UserAssignmentsCreateRoleAssignment400Response
     */
    'title': string;
    /**
