 ...
 * 
 * @export
 * @interface ForecastOverridesOverrideInterval500Response
 */
export interface ForecastOverridesOverrideInterval500Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof ForecastOverridesOverrideInterval500Response
     */
    'title': string;
    /**
