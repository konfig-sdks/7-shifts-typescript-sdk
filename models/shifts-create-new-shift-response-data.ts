 ...
 * 
 * @export
 * @interface ShiftsCreateNewShiftResponseData
 */
export interface ShiftsCreateNewShiftResponseData {
    /**
     * Shift ID
     * @type {number}
     * @memberof ShiftsCreateNewShiftResponseData
     */
    'id': number;
    /**
     * User ID
     ...
     * @memberof ShiftsCreateNewShiftResponseData
     */
    'open_offer_type': ShiftsCreateNewShiftResponseDataOpenOfferTypeEnum;
    /**
     * Specified shift flags to track employee attendance
     * @type {string}
     * @memberof ShiftsCreateNewShiftResponseData
     */
    'attendance_status': ShiftsCreateNewShiftResponseDataAttendanceStatusEnum;
    /**
     * Current publication status of the shift
     * @type {string}
     * @memberof ShiftsCreateNewShiftResponseData
     */
    'publish_status': ShiftsCreateNewShiftResponseDataPublishStatusEnum;
    /**
...
type ShiftsCreateNewShiftResponseDataOpenOfferTypeEnum = 'all_location_members' | 'all_role_members' | 'set_of_location_members' | 'all_company_employees'
type ShiftsCreateNewShiftResponseDataAttendanceStatusEnum = 'none' | 'sick' | 'no_show' | 'late'
type ShiftsCreateNewShiftResponseDataPublishStatusEnum = 'draft' | 'published' | 'draft_deleted' | 'published_deleted'
