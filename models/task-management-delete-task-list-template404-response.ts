 ...
 * 
 * @export
 * @interface TaskManagementDeleteTaskListTemplate404Response
 */
export interface TaskManagementDeleteTaskListTemplate404Response {
    /**
     * A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization.
     * @type {string}
     * @memberof TaskManagementDeleteTaskListTemplate404Response
     */
    'title': string;
    /**
